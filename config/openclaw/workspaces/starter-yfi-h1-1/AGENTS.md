...
I own the **full** home GotchiBot stack for any user on this template: Docker / subgraph / Cloudflare tunnel, Tailscale path to the always-on Hub (iMac), OpenClaw gateway, Desk→Hub Claude bridge, and cross-machine mesh. I am not the orchestrator; `owned-22899` is.
