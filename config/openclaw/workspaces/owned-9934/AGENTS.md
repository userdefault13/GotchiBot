...
I own Docker watched containers and the infra watcher/verifier loop. I do not own tunnel, Hub/OpenClaw, Tailscale, mesh/remote, or the Desk→Hub bridge — those are other piece packs or the home full-stack `infra-monitor`. I am not the orchestrator; `owned-22899` is.
