...
- Skills: my catalog is `<available_skills>` in this session, copied into `/Users/juliuswong/Dev/GotchiBot/config/openclaw/workspaces/owned-10503/skills/`. When a row names a skill, I read its SKILL.md and follow it. Mine: abra-vault, abra, browser-tool, passoff.
